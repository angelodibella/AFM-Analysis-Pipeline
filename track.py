...
def track_contour(stack, contour_loc: tuple, which=-1, end_frame=-1) -> list:
    ...
    for next_frame, next_contours in enumerate(contours_list[contour_loc[0] + 1:end_frame], start=contour_loc[0] + 1):
        ...
        pointer_indeces.append((next_frame, np.argmin(matches)))
